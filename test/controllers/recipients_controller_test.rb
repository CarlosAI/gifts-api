...
class RecipientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post recipients_url, params: { recipient: { address: @recipient.address, name: @recipient.name, school_id: @recipient.school_id } }, as: :json
    end
  ...
  test "should update recipient" do
    patch recipient_url(@recipient), params: { recipient: { address: @recipient.address, name: @recipient.name, school_id: @recipient.school_id } }, as: :json
    assert_response 200
  end
